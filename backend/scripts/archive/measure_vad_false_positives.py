...
Examples:
    uv run python scripts/archive/measure_vad_false_positives.py --data-dir data --job-id abc123
    uv run python scripts/archive/measure_vad_false_positives.py --data-dir data --all-jobs
"""
