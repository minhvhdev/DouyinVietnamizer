#!/usr/bin/env python3
"""Run TTS -> render smoke test with OmniVoice on a synthetic local job."""
...
def main() -> int:
    ...
    from dv_backend.omnivoice_env import is_omnivoice_available
    ...
    if not is_omnivoice_available():
        print("OmniVoice env missing. Run: python scripts/setup_omnivoice.py", file=sys.stderr)
        return 1

    data_dir = backend_dir / ".data-omnivoice-smoke"
    if data_dir.exists():
        import shutil
            ...
            "segments": [
                {
                    ...
                    "end": 3.5,
                    "text": "你好",
                    "translation": "Xin chào, đây là thử nghiệm lồng tiếng bằng OmniVoice.",
                    "duration_budget": 3.5,
                }
            ],
        },
    ...
    print("Running TTS with OmniVoice...")
